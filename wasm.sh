...
function override_connection() {
    ...
    local configure_args="{\"override_connection\":{\"connection_id\":\"$conn_id\",\"counterparty_port_id\":\"$dst_port_id\",\"counterparty_nid\":\"$ICON_NETWORK_ID\",\"client_id\":\"${client_id}\",\"timeout_height\":30000}}"
    local xcall_connection=$(cat ${CONTRACT_ADDR_WASM_XCALL_CONNECTION})
